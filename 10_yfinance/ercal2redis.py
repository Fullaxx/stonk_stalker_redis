...
def get_sunday_reference():
	...
	today_date = datetime.date.fromisoformat(now_et_str)

#	Mon=0, Tue=1, Wed=2, Thu=3, Fri=4, Sat=5, Sun=6
	day_num_of_week = today_date.weekday()
...
#	Once we hit Saturday, we start calcualting from tomorrow's Sunday
	...
	sunday = today_date + datetime.timedelta(days=days_offest)
	print(f'{today_date} {sunday}')
	return sunday
